...
png(
  filename = "C:/Users/shuyan/Desktop/项目文件夹/output/figures/fig5_author_barplot.png",
  width = 2200,
  height = 2600,
  res = 300
)
...
write.csv(
  Dataset_Biomass,
  "C:/Users/shuyan/Desktop/项目文件夹/output/tables/fig5_plot_data_author.csv",
  row.names = FALSE
)

cat("Fig. 5 已保存到 output/figures/fig5_author_barplot.png\n")
cat("Fig. 5 数据已保存到 output/tables/fig5_plot_data_author.csv\n")
